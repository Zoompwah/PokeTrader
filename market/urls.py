...
from .views import card_detail,market, create_listing, notifications, purchase_card, make_offer, accept_offer, reject_offer, cancel_transaction, complete_transaction
app_name = 'market'
urlpatterns = [
